...
export class MergifyReporter implements Reporter {
  ...
  onInit(vitest: Vitest): void {
    ...
    // One client for the whole run: quarantine, flaky detection and the trace
    // upload all go through it. Null without a token, a detected repository, or
    // a native binding for this platform — each of which means the backend
    // features stay off.
    const apiClient =
